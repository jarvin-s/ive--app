    ...
    return (
        ...
        >
            <div className='flex w-[1216px] flex-col items-end p-[24px] text-pink-500 md:pr-[30%]'>
                ...
                <h2 className='mb-2 text-7xl font-black'>유진</h2>
                <p className='w-full rounded-lg border-4 border-white bg-pink-500 p-2.5 text-center text-white md:text-right lg:max-w-[500px]'>
