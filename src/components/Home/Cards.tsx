        ...
        <>
            ...
            */}
            ...
            <div className='mx-auto flex max-w-7xl flex-col items-center justify-evenly gap-4 xl:flex-row'>
                <Card className='relative mx-4 max-w-[387px] overflow-hidden border-4 border-pink-600 bg-pink-200'>
                ...
                <Card className='relative mx-4 max-w-sm overflow-hidden border-4 border-pink-600 bg-pink-200'>
                    <CardContent className='p-0'>
                        <div className='relative aspect-video'>
                            <Image
