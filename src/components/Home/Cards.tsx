        ...
        <>
            ...
            */}
            <div className='bg-zinc-900'>
                <div className='mx-auto flex max-w-7xl flex-col items-center justify-evenly gap-4 xl:flex-row'>
                    <Card className='relative bottom-[8rem] mx-4 max-w-[387px] animate-small-bounce-left overflow-hidden border-4 border-pink-600 bg-pink-200 xl:animate-small-bounce-left-rotate'>
                    ...
                    <Card className='relative bottom-[8rem] mx-4 max-w-[387px] animate-small-bounce-middle overflow-hidden border-4 border-pink-600 bg-pink-200 xl:animate-small-bounce-middle-rotate'>
                        <CardContent className='p-0'>
                            <div className='relative aspect-video'>
                                <Image
                    ...
                    <Card className='relative bottom-[8rem] mx-4 max-w-sm animate-small-bounce-right overflow-hidden border-4 border-pink-600 bg-pink-200 xl:animate-small-bounce-right-rotate'>
                        <CardContent className='p-0'>
                            <div className='relative aspect-video'>
                                <Image
