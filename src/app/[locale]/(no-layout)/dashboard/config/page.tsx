                ...
                <div className='w-full space-y-6 text-white'>
                    <div className='space-y-2'>
                        ...
                        >
                            ...
                            <option value='members'>
                                {t('configure.categories.members')}
                            </option>
                            <option value='songs'>
                                {t('configure.categories.songs')}
                            </option>
                            <option value='albums'>
                                {t('configure.categories.albums')}
                            </option>
                            <option value='facts'>
                                {t('configure.categories.facts')}
                            </option>
                        </select>
                    </div>
                    ...
                    <div className='space-y-2'>
                        <label className='text-lg font-medium'>
                            {t('configure.question_count_label')}
                        </label>
                        <select
                            className='w-full rounded-lg bg-stone-800 p-3 text-white'
                            value={questionCount}
                        ...
                        >
                            <option value='5'>
                                {t('configure.question_count_options.5')}
                            </option>
                            <option value='10'>
                                {t('configure.question_count_options.10')}
                            </option>
                            <option value='15'>
